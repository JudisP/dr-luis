...
import { Col, Container, ModalBody, ModalHeader, Row } from "reactstrap";
          ...
          <Container className="conteiner-boas-vindas">
            <Row className="row-boas-vindas">
              <Col className="apresentacao">
                ...
                <Link
                  to="/dr-luis/procedimentos"
                  onClick={() => scrollTop(0, 0)}
                >
              ...
              <div className="elemento">
                ...
                <div className="conteudo">
                  ...
                  <span>
                    ...
                    vasculares como: histórico na família, tabagismo, diabetes,
                    hipertensão. Não ignore seus sintomas!
                  </span>
                </div>
              </div>
              <div className="elemento">
                ...
                <div className="conteudo">
                  ...
                  <span>
                    ...
                    identificação de problemas pós-Covid.
                  </span>
                </div>
              </div>
